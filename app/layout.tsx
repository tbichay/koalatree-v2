  ...
  return (
    <html lang="de" className={`${geistSans.variable} h-full antialiased`}>
      <head>
        ...
        <link rel="icon" type="image/png" sizes="32x32" href="/api/icons/favicon-32.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="/api/icons/favicon-16.png" />
        <link rel="apple-touch-icon" sizes="180x180" href="/api/icons/apple-touch-icon.png" />
      </head>
