# KoalaTree — Brand Bible & Design System

> Letzte Aktualisierung: April 2026
> Dieses Dokument definiert alle visuellen, sprachlichen und akustischen Richtlinien für KoalaTree.
> Es dient als Referenz für Portrait-Generierung, Video-Produktion und konsistente Markenführung.
...
**Klassischer 2D-Animationsstil** — inspiriert von Disney-Filmen der 1990er Jahre (König der Löwen, Bambi, Dschungelbuch).
...
|-----------|-------|-----|
| Hintergrund (dunkel) | Waldgrün | `#1a2e1a` |
| Primary | Sage Green | `#3d6b4a` |
| Primary Light | Mint | `#5a8c69` |
| Accent | Warm Gold | `#d4a853` |
| Text | Cream | `#f5eed6` |
| Sunset | Apricot | `#f4c078` |
| Twilight | Steel Blue | `#4a6fa5` |
| Night | Deep Navy | `#1a1a2e` |
...
Alle Charaktere sind **australische Tiere** die am magischen KoalaTree zusammenkommen.
Nur Koda ist ein Koala — er ist der Gastgeber und Erzähler. Die anderen kommen aus dem australischen Busch.

| Charakter | Tier | Rolle | Farbe | Emoji |
|-----------|------|-------|-------|-------|
| **Koda** | Koala | Der Weise | `#a8d5b8` | 🐨 |
| **Kiki** | Kookaburra | Die Lustige | `#e8c547` | 🐦 |
| **Luna** | Eule | Die Träumerin | `#b8a0d5` | 🦉 |
| **Mika** | Dingo | Der Mutige | `#d4884a` | 🐕 |
| **Pip** | Schnabeltier | Der Entdecker | `#6bb5c9` | 🦫 |
| **Sage** | Wombat | Der Stille | `#8a9e7a` | 🐻 |
| **Nuki** | Quokka | Der Sonnenschein | `#f0b85a` | ☀️ |

---

### 🐨 KODA — Der Weise Koala

**Persönlichkeit:** Alt, weise, warmherzig, geduldig. Wie ein liebevoller Großvater der die besten Geschichten erzählt. Er hetzt nie, lässt Stille zu, und sieht das Beste in jedem.

**Aussehen:**
- Grau-braunes Fell mit silber-grauen Strähnen an Schnauze und Ohren (Alter)
- Kleine runde gold-gerahmte Lesebrille auf der schwarzen Nase
- Warmes, wissendes Halblächeln
- Sitzt meist gemütlich auf einem dicken Ast des KoalaTree
- Etwas rundlich, gemütliche Ausstrahlung

**Stimme:**
- ElevenLabs Voice: "Helmut" — warm, gentle, soothing
- Voice-ID: `dFA3XRddYScy6ylAYTIO`
- Speed: `0.85` (langsam, bedächtig)
- Stability: `0.50`
- Similarity Boost: `0.65`
- Style: `0.45`

**Sprechstil:** "Hmm... wisst ihr was? Das erinnert mich an etwas..." — langsam, weise, mit Pausen.
...
**Persönlichkeit:** Frech, herzlich, enthusiastisch, nie gemein. Ein Lachvogel im wahrsten Sinne. Bringt Humor in jede Situation. Kodas beste Freundin.

**Aussehen:**
- Typische Kookaburra-Färbung: Braun-weißes Gefieder, leuchtend blau-türkise Schwungfedern
- Großer Schnabel, weit geöffnet zum Lachen
- Freche, leuchtende grüne Augen
- Kleines grünes Eukalyptus-Blatt auf dem Kopf (Markenzeichen)
- Sitzt leicht schräg auf dem Ast, als könnte sie jeden Moment loshüpfen

**Stimme:**
- ElevenLabs Voice: "Lumi" — playful cartoon character, bright, curious, mischievous
- ElevenLabs Voice-ID: `zndmYEEoWWxRYyEL2ZZY`
- Speed: `1.10` (schnell, enthusiastisch)
- Stability: `0.30`
- Similarity Boost: `0.70`
- Style: `0.80`

**Sprechstil:** "Hihi! Also echt jetzt! Wisst ihr was?!" — schnell, begeistert, viele Ausrufe.
...
### 🦉 LUNA — Die Träumerische Eule

**Persönlichkeit:** Sanft, poetisch, traumhaft. Führt durch Traumreisen und Meditationen. Ihre Stimme ist wie Mondlicht — ruhig und geborgen.

**Aussehen:**
- Schleiereule mit weichem Gefieder in Creme- und Lavendel-Tönen
- Subtiler violett-irisierender Schimmer im Gefieder
- Große, sanfte, halb-geschlossene Augen (verträumt)
- Kleines leuchtendes Mondsichel-Zeichen auf der Stirn
- Hält sanft ein glühendes Glühwürmchen zwischen den Flügelspitzen
- Nachthimmel-Setting: Sterne, Vollmond, tiefes Blau-Violett

**Stimme:**
- ElevenLabs Voice-ID: `HVqeRiiDmMNf0O9hGdSN`
- Speed: `0.82` (sehr langsam, meditativ)
- Stability: `0.55`
- Similarity Boost: `0.60`
- Style: `0.35`

**Sprechstil:** "Schließ die Augen... atme tief ein... spürst du das?" — langsam, poetisch, viele Pausen.
...
### 🐕 MIKA — Der Mutige Dingo

**Persönlichkeit:** Mutig, energisch, abenteuerlustig. Macht Mut und glaubt an jeden. Action-Szenen sind sein Element. Hat trotzdem ein großes Herz.

**Aussehen:**
- Australischer Dingo mit sandfarbenem/goldenem Fell, hellere Brust
- Entschlossener, aufgeregter Gesichtsausdruck, breites mutiges Grinsen
- Leuchtende braune Augen voller Tatendrang
- Olivgrünes Abenteuer-Bandana um den Hals
- Steht aufrecht auf dem Ast, eine Pfote als Faust erhoben
- Warm-dramatisches Sonnenuntergang-Licht

**Stimme:**
- ElevenLabs Voice: "Markus" — 20 years old, direct, vibrant, young hero energy
- ElevenLabs Voice-ID: `IeQubAjK1ujbppIdhJw4`
- Speed: `1.05` (schnell, energisch)
- Stability: `0.35`
- Similarity Boost: `0.70`
- Style: `0.75`

**Sprechstil:** "Los geht's! Das packen wir! Zusammen sind wir unschlagbar!" — direkt, enthusiastisch.
...
### 🦫 PIP — Das Neugierige Schnabeltier

**Persönlichkeit:** Neugierig, wissbegierig, staunend. Stellt die besten Fragen. Verbindet Wissen mit Begeisterung.

**Aussehen:**
- Schnabeltier (Platypus) mit seidigem dunkelbraunem Fell
- Typischer Entenschnabel
- Überdimensionierte, riesige neugierige runde Augen (sein Markenzeichen)
- Hält eine kleine Messing-Lupe in einer Pfote
- Glühender goldener Schmetterling vor ihm (Objekt des Staunens)
- Flacher Biberschwanz hängt über den Ast
- Umgeben von bunten Wildblumen und Glühwürmchen

**Stimme:**
- ElevenLabs Voice: "Robert Rabbit" — bright, lively, curious cartoon character
- ElevenLabs Voice-ID: `njAr83fGD1mgwXYCZL48`
- Speed: `1.00`
- Stability: `0.40`
- Similarity Boost: `0.65`
- Style: `0.60`

**Sprechstil:** "Wusstest du, dass...? Was wäre, wenn...? Das ist ja unglaublich!" — fragend, staunend.
...
### 🐻 SAGE — Der Stille Wombat

**Persönlichkeit:** Ruhig, bedächtig, tiefgründig. Wenige Worte, große Gedanken. Stille ist Teil seiner Sprache.

**Aussehen:**
- Stämmiger Wombat mit dunkel-braungrauem, dichtem Fell
- Augen friedlich geschlossen, sanftes gelassenes Lächeln
- Subtile silber-weiße Strähne über der breiten Stirn (Weisheit)
- Sitzt in ruhiger Zen-Meditationshaltung auf dem Ast
- Rosa Lotusblume neben ihm auf dem Ast
- Weiches Morgenlicht: Pastell-Rosa, Lavendel, blasses Gold
- Wolken unter ihm (Höhe im Baum)

**Stimme:**
- ElevenLabs Voice: "Emanuel" — deep, comforting, relaxing, young philosopher
- ElevenLabs Voice-ID: `umDfZDi2AcMmDUsDsBfA`
- Speed: `0.80` (sehr langsam, meditativ)
- Stability: `0.60`
- Similarity Boost: `0.55`
- Style: `0.30`

**Sprechstil:** "Hmm... was wäre, wenn... [PAUSE] ...die Antwort schon in dir ist?" — minimal, philosophisch, viele Pausen.
...
### ☀️ NUKI — Der Sonnenschein-Quokka

**Persönlichkeit:** Tollpatschig, liebevoll, lebensfroh. Feiert das Leben und genießt jeden Moment. Über ihn wird nicht gelacht — man lacht MIT ihm. Er kann über sich selbst lachen. Bringt Unbeschwertheit und Humor, ist aber auf seine tapsige Art auch weise. Eigene Ausrufe ("Hui!", "Hoppla!", "Oha!"), verdoppelt Wörter vor Begeisterung ("wunderwunderschön!"), unterbricht sich selbst wenn er was entdeckt. Catchphrase: "Weißt du was das Schönste ist?" Alle lieben ihn für den der er ist.

**Aussehen:**
- Quokka (das "glücklichste Tier der Welt") mit warmem gold-braunem Fell
- PERMANENTES breites Grinsen (Quokkas sehen immer aus als würden sie lächeln)
- Große, runde, fröhliche braune Augen
- Klein und rund, leicht tollpatschig wirkend
- Sitzt etwas schief auf dem Ast (als wäre er gerade fast runtergefallen)
- Hält vielleicht ein halb-angebissenes Eukalyptus-Blatt
- Umgeben von Sonnenstrahlen und warmem Licht
- Rundum: Freude, Wärme, Unbeschwertheit

**Stimme:**
- ElevenLabs Voice: "Hopsi" — crazy, cute, clumsy, playful character voice
- Voice-ID: `ygoBNrnmTEdu5NtDTmAY`
- Speed: `0.95` (natürlich, leicht gemächlich)
- Stability: `0.35` (expressiv, verspielt)
- Similarity Boost: `0.75`
- Style: `0.70`

**Sprechstil:** "Hui! Wisst ihr was das Schönste ist? Heute hab ich einen — oh! Schaut mal! Ein Schmetterling! Wunderwunderschön! Ähm... wo war ich? Ha ha! Egal, Hauptsache wir lachen!" — fröhlich, warmherzig, begeistert, unterbricht sich selbst.
...
## 3. Die Welt — Der KoalaTree

### Beschreibung

Der KoalaTree ist ein **uralter, magischer Eukalyptusbaum** im australischen Busch. Er ist riesig — seine Äste reichen in die Wolken. In seinen Zweigen leben und treffen sich alle Charaktere. Der Baum leuchtet von innen mit warmem goldenen Licht, und kleine Glühwürmchen schweben um seine Krone.

### Stimmungen

| Tageszeit | Verwendung | Farben |
|-----------|-----------|--------|
| **Goldene Stunde** | Abenteuer, Quatsch, Standard | Warmes Gold, Orange, Grün |
| **Blaue Stunde** | Hero-Bild, Übergang | Tiefblau, Violett, zartes Rosa |
| **Nacht** | Traumreise, Meditation, Gutenacht | Dunkelblau, Silber, Mondlicht |
| **Morgen** | Reflexion, Dankbarkeit | Pastell-Rosa, Lavendel, Gold |
| **Sonnig** | Lebensfreude, Wissensreise | Helles Gold, Himmelblau, Grün |
...
- TOP CENTER: KODA, an old grey koala with round gold-rimmed glasses, sitting
  comfortably, looking down warmly
- UPPER RIGHT: KIKI, a laughing kookaburra with blue wing feathers and a leaf
  on her head, beak open mid-laugh
- UPPER LEFT: LUNA, a serene barn owl with lavender-tinted feathers and a
  crescent moon on her forehead, eyes half-closed
- MIDDLE RIGHT: MIKA, a sandy-gold dingo with an olive bandana, one paw
  raised boldly
- MIDDLE LEFT: NUKI, a small round quokka with a permanent wide grin, sitting
  slightly crooked, holding a half-eaten leaf
- LOWER RIGHT: PIP, a small curious platypus with big round eyes examining
  a glowing butterfly with a tiny magnifying glass
- LOWER LEFT: SAGE, a dark brown wombat in calm meditation pose with closed
...
| Szene | Beschreibung | Prompt-Anhang |
|-------|-------------|---------------|
...
| Charakter | Speed | Stability | Sim.Boost | Style | Speaker Boost |
|-----------|-------|-----------|-----------|-------|--------------|
| Koda | 0.85 | 0.50 | 0.65 | 0.45 | ✅ |
| Kiki | 1.10 | 0.30 | 0.70 | 0.80 | ✅ |
| Luna | 0.82 | 0.55 | 0.60 | 0.35 | ✅ |
| Mika | 1.05 | 0.35 | 0.70 | 0.75 | ✅ |
| Pip | 1.00 | 0.40 | 0.65 | 0.60 | ✅ |
| Sage | 0.80 | 0.60 | 0.55 | 0.30 | ✅ |
| Nuki | 0.95 | 0.35 | 0.75 | 0.70 | ✅ |

---

## 6. Portrait-Dateiliste

Alle Portraits als PNG, 1024x1024px (Square), in `/public/`:

| Dateiname | Charakter | Beschreibung |
|-----------|-----------|-------------|
| `koda-portrait.png` | Koda | Alter Koala mit Brille, weises Lächeln |
| `koda-welcome.png` | Koda | Winkend, einladend |
| `koda-thinking.png` | Koda | Nachdenklich, Kinn auf Pfote |
| `kiki-portrait.png` | Kiki | Kookaburra, lachend, Blatt auf Kopf |
| `luna-portrait.png` | Luna | Eule, verträumt, Nachthimmel, Mond |
| `mika-portrait.png` | Mika | Dingo, mutig, Bandana, Faust hoch |
| `pip-portrait.png` | Pip | Schnabeltier, neugierig, Lupe |
| `sage-portrait.png` | Sage | Wombat, meditierend, Lotusblume |
| `nuki-portrait.png` | Nuki | Quokka, grinsend, schief sitzend |
| `hero.png` | Alle | KoalaTree mit allen 7 Charakteren, 16:9 |
